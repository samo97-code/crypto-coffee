        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="flex items-center gap-3 mb-8">
                <div className="p-3 bg-coffee-200 dark:bg-coffee-100 rounded-full">
                    <FileText className="h-6 w-6 text-amber-800 dark:text-coffee-900"/>
                </div>
                <h1 className="text-3xl font-bold text-coffee-900">Terms of Service</h1>
            </div>

            <div className="bg-card rounded-lg p-8 shadow-sm border border-coffee-200 dark:border-coffee-600/50">
