    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="flex items-center gap-3 mb-8">
                <div className="p-3 bg-coffee-200 dark:bg-coffee-100 rounded-full">
                    <Shield className="h-6 w-6 text-amber-800 dark:text-coffee-900"/>
                </div>
            ...
            <div className="bg-card rounded-lg p-8 shadow-sm border border-coffee-200">
                <div className="prose prose-amber max-w-none">
                    <p className="text-amber-800 dark:text-coffee-900 font-medium">Last Updated: April 3, 2025</p>
                    ...
                    <h3 className="text-lg font-medium text-coffee-800 mt-6">1.2 Automatically Collected
                        Information</h3>
                    ...
                    <p>
                        ...
                        the new
                        Privacy Policy on this page and updating the &#34;Last Updated&#34; date. You are advised to
                        review this
                        Privacy
                    ...
                    <p className="mt-2">
                        <a href="mailto:crypto.coffee.web3@gmail.com"
                           className="text-coffee-700 hover:text-coffee-900 underline">
                            crypto.coffee.web3@gmail.com
                        </a>
                    </p>
                </div>
            </div>
            ...
            <div className="mt-8 flex justify-between items-center">
                ...
                <Link href="/">
                    <Button
                        className="gap-2 bg-gradient-to-br from-coffee-500 to-coffee-700 dark:from-coffee-50 dark:to-coffee-200/25 hover:from-coffee-600 hover:to-coffee-800 text-white">
