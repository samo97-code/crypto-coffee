            ...
            <ul className="flex items-center gap-2">
                {projects.map((project) => {
                    return <li key={project.id}
                               ...
                               className={`${project.blockchain_networks[0].chain_id === chainId ? 'bg-coffee-800 dark:bg-coffee-50/50' : 'hover:bg-coffee-100 dark:hover:bg-coffee-50/40'}  flex items-center gap-1 cursor-pointer border border-coffee-200 dark:border-coffee-600/50 rounded-md px-2 py-2 transition-colors`}
                    >
