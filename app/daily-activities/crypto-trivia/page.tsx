        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden mb-8">
          <div className="p-6 pb-4 border-b border-border">
            ...
            <p className="text-coffee-600">
              Test your crypto knowledge with a daily trivia question. Answer correctly to earn badges and points!
            </p>
          </div>
          ...
          <div className="p-6">
            <div className="bg-coffee-50 rounded-lg p-6 mb-6">
              ...
              <p className="text-coffee-900 mb-6">What was the first cryptocurrency to implement smart contracts?</p>
              ...
              <RadioGroup value={selectedAnswer || ""} onValueChange={setSelectedAnswer} disabled={hasSubmitted}>
                <div className="space-y-3">
                  ...
                  >
                    ...
                    {hasSubmitted && "a" === correctAnswer && <CheckCircle2 className="h-5 w-5 text-green-600" />}
                  ...
                  >
                    ...
                    {hasSubmitted && "b" === correctAnswer && <CheckCircle2 className="h-5 w-5 text-green-600" />}
                  ...
                  >
                    ...
                    {hasSubmitted && "c" === correctAnswer && <CheckCircle2 className="h-5 w-5 text-green-600" />}
                  ...
                  >
                    ...
                    {hasSubmitted && "d" === correctAnswer && <CheckCircle2 className="h-5 w-5 text-green-600" />}
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-green-700 text-sm">
                          Ethereum was the first cryptocurrency to implement smart contracts, which are self-executing
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-red-700 text-sm">
                          The correct answer is Ethereum. It was the first cryptocurrency to implement smart contracts,
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-coffee-600">
                  Pay a small fee of $0.045 (like a sip of coffee) to answer the daily trivia question.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-coffee-600">Test your crypto knowledge with a new question every day.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-coffee-600">
                  Correct answers earn you badges, points, and special NFTs that showcase your knowledge.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-coffee-600">
                  Answer correctly multiple days in a row to earn streak bonuses and exclusive rewards.
                </p>
              </div>
            </div>
          </div>
