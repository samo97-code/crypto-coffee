      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-coffee-600">
            Support the project while having fun with these daily activities. Each activity costs just $0.045 (like a
            sip of coffee).
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {dailyActivities.map((activity) => (
                      <Link key={activity.id} href={`/daily-activities/${activity.id}`}>
                        <DailyActivityCard activity={activity} isCompleted={completedActivities.includes(activity.id)}/>
                      </Link>
                  ))}
                </div>
              </TabsContent>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-coffee-600 mb-3">
                You've completed at least one activity for 7 days in a row! Keep it up to earn bonus rewards.
              </p>
              <div className="flex gap-2 mb-4">
                ...
                <div className="w-8 h-8 rounded-full flex items-center justify-center bg-coffee-200 text-coffee-600">
                  8
                </div>
                <div className="w-8 h-8 rounded-full flex items-center justify-center bg-coffee-200 text-coffee-600">
                  9
