...
import {Laugh, ArrowLeft, Share2, ThumbsUp, Copy} from "lucide-react"
                ...
                <div className="bg-card border border-border rounded-lg overflow-hidden mb-8">
                    <div className="p-6 pb-4 border-b border-border">
                        ...
                        <p className="text-coffee-600">
                            Start your day with a laugh! Reveal today&#39;s crypto-themed joke and share it with your
                            friends.
                        </p>
                    </div>
                    ...
                    <div className="p-6">
                        {isRevealed ? (
                            <div className="bg-yellow-50 rounded-lg p-6 mb-6 border border-yellow-200">
                                ...
                                <div className="text-xl text-coffee-900 mb-6 font-medium">Why did the blockchain go to
                                    therapy?
                                </div>
                            ...
                            <div className="bg-coffee-50 rounded-lg p-6 mb-6 border border-coffee-200 text-center">
                                ...
                                <h2 className="text-lg font-medium text-coffee-900 mb-2">Today&#39;s Crypto Joke is
                                    Ready!</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-coffee-600">Have a laugh and share the joke with your friends on
                                    social media.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-coffee-600">Access your joke history and build a collection of crypto
                                    humor.</p>
                            </div>
                        </div>
