        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden mb-8">
          <div className="p-6 pb-4 border-b border-border">
            ...
            <p className="text-coffee-600">
              Play daily bingo for a chance to win weekly and monthly rewards. Mark your card and match today's numbers!
            </p>
          </div>
          ...
          <div className="p-6">
            {isRevealed ? (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button variant="outline" className="border-coffee-200" onClick={() => setSelectedNumbers([])}>
                      Clear Selection
                    </Button>
                  </div>
                </div>
              ...
              <div className="bg-coffee-50 rounded-lg p-6 mb-6 border border-coffee-200 text-center">
                ...
                <h2 className="text-lg font-medium text-coffee-900 mb-2">Today's Bingo Numbers are Ready!</h2>
                <p className="text-coffee-600 mb-6">
                  Pay a small fee to reveal today's bingo numbers and play for a chance to win weekly and monthly
                  prizes.
                </p>
                <Button
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-coffee-600">
                  Play consistently to qualify for weekly draws and the monthly jackpot with bigger rewards.
                </p>
              </div>
            </div>
          </div>
