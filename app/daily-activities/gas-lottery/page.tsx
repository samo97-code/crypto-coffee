        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden mb-8">
          <div className="p-6 pb-4 border-b border-border">
            ...
            <p className="text-coffee-600">
              Pay a small fixed fee ($0.045) daily for a chance to win accumulated rewards or a special NFT. The more
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 pb-3 border-b border-coffee-200">
                ...
                <div>
                  ...
                  <div className="text-sm text-coffee-600">1 in 1,000 chance • Special access to premium features</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 pb-3 border-b border-coffee-200">
                ...
                <div>
                  ...
                  <div className="text-sm text-coffee-600">For all winners • Displayed on your profile</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-coffee-600">Monthly special draw • Exclusive community benefits</div>
                </div>
              </div>
            </div>
          </div>
