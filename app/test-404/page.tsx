        ...
        <div className="min-h-screen bg-amber-50 flex flex-col items-center justify-center p-4">
            <div className="max-w-2xl w-full text-center">
                <div className="relative mb-8 mx-auto w-64 h-64">
                    ...
                    >
                        <div className="relative">
                            {/* Cup */}
                            <div className="w-40 h-32 bg-white rounded-b-full border-4 border-amber-900 overflow-hidden">
                                <div className="absolute top-0 left-0 w-full h-full bg-amber-800/20"></div>
                                <div className="absolute bottom-0 left-0 w-full h-1/2 bg-amber-800/40 rounded-b-full"></div>
                            </div>

                            {/* Handle */}
                            <div className="absolute top-6 -right-8 w-12 h-16 border-4 border-amber-900 rounded-r-full"></div>

                            {/* Cup top */}
                            <div className="absolute -top-4 left-0 w-40 h-8 bg-amber-50 border-4 border-amber-900 rounded-full">
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-2 bg-amber-800/20 rounded-full"></div>
                            </div>

                            {/* 404 text in coffee */}
                            <div className="absolute top-8 left-1/2 -translate-x-1/2 text-3xl font-bold text-amber-900/80">404</div>
                        </div>
                    </div>
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex items-center">
                        <div className="w-12 h-12 bg-amber-200 rounded-lg border-2 border-amber-900 flex items-center justify-center animate-wobble-left">
                        ...
                        <div className="w-12 h-12 bg-amber-200 rounded-lg border-2 border-amber-900 flex items-center justify-center animate-wobble-right">
                ...
                <p className="text-lg text-amber-800 mb-8 animate-fade-in animation-delay-200">
                    Looks like our blockchain spilled the coffee beans! The page you're looking for has been brewed away or never
                    existed.
                </p>
